...
<div align="center">
  ...
  <h2>
    ...
    &nbsp;&nbsp;&nbsp;
    <a href="/${requestScope.contextPath}/logado/admin/cadastro">Adicionar Novo Admin</a>
  </h2>
</div>
<div align="center">
  <table border="1">
    ...
    <c:forEach var="admin" items="${requestScope.listaAdmins}">
      <tr>
        ...
        <td>${admin.email}</td>
        <td>
          <a href="/${requestScope.contextPath}/logado/admin/edicao?id=${admin.id_usuario}">Edição</a>
          &nbsp;&nbsp;&nbsp;
          <a href="/${requestScope.contextPath}/logado/admin/remocao?id=${admin.id_usuario}"
